...
public class RSAOAEPEncryptionGadget extends Gadget{
	...
	public RSAOAEPEncryptionGadget(Wire eIn, Wire[] nIn, Wire[] nReIn, Wire[] msg, Wire[] rnd) {
		//Public inputs
		this.eIn = eIn;
		this.nIn = nIn;
		this.nReIn = nReIn;
	...
	private void buildCircuit(){
		...
		Wire[] proverWitnessWires = bIn;
		PinocchioGadget powerModGenerator = new PinocchioGadget(inputWires, proverWitnessWires, "rsa-enc.2048.arith");
