...
public class SHA256For256 extends CircuitGenerator {
	...
	public SHA256For256(int[] msg) throws Exception {
		
		super("sha256-" + msg + System.currentTimeMillis());
		if (msg.length != BLOCK_NUM) throw new Exception("Must have 8 inputs of int!"); 
		this.msg = msg;
	...
	protected void buildCircuit() {
		// assuming the circuit input will be 16 integers
		inputWires = createInputWireArray(BLOCK_NUM);
		// this gadget is not applying any padding.
		sha2Gadget = new SHA256Gadget(inputWires, 32, 32, false, true);
